...
class AccountPageLocators:
    ...
    BUTTON_RESET_PASSW2 = (By.CSS_SELECTOR, '[class="LinkButton-module__wrapper LinkButton-module__tiny '
                                            'LinkButton-module__regular LinkButton-module__blue"]')
    ...
    BUTTON_REGISTRATION2 = (By.CSS_SELECTOR, '[class="BaseRadioButton-module__radioButtonContainer '
                                             'LoginForm_switcherOption__eUH9g"]')
