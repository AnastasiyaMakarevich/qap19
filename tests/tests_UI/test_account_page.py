...
@allure.title('Field password is empty message')
def test_field_password_is_empty(driver):
    main_page = MainPage(driver)
    main_page.open_page_and_reject_cookies()
...
def test_registration_that_incorrect_email(driver):
    ...
    account_page.set_phone_number_in_registration_if_necessary('330000000')
